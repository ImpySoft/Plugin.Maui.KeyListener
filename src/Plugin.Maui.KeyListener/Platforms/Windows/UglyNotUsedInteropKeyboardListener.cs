...
//		subscriptionCount--;
//		if (subscriptionCount == 0 && hookId != IntPtr.Zero)
//		{
...
//			var activeWindow = GetActiveMauiWindow();
...
//			{
//				var key = MapVirtualKeyToKeyboardKey(unchecked((int)kb.vkCode));
...
//	bool IsBehaviorAttachedToWindow(Window? activeWindow)
//	{
...
//	KeyboardKeys MapVirtualKeyToKeyboardKey(int vkCode)
//	{
...
//			{
//				var windowHwnd = WindowNative.GetWindowHandle(nativeWindow);
