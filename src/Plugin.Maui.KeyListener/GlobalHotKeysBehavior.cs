...
/// Unlike <see cref="KeyboardBehavior" />, which typically handles keyboard events scoped to a specific control or view,
/// <c>GlobalHotKeysBehavior</c> attaches to the root element of each window and listens for key events at the application level.
...
public partial class GlobalHotKeysBehavior : PlatformBehavior<VisualElement>
{
    ...
    /// Setting <see cref="KeyPressedEventArgs.Handled" /> to true will prevent the event from propagating further up the visual tree.
    /// </summary>
